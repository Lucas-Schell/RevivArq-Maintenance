...
module.exports = () => {
    const schema = new Schema({
        ...
        reformItens: { type: {
            fachada: { type: Boolean, unique: false, required: true, default: false },
            identidadeEComunicação: { type: Boolean, unique: false, required: true, default: false },
            paredesERevestimentos: { type: Boolean, unique: false, required: true, default: false },
            forro: { type: Boolean, unique: false, required: true, default: false },
            iluminacao: { type: Boolean, unique: false, required: true, default: false },
            projetoImobiliario: { type: Boolean, unique: false, required: true, default: false },
            paisagismo: { type: Boolean, unique: false, required: true, default: false },
            projetoEletrico: { type: Boolean, unique: false, required: true, default: false },
            projetoHidraulico: { type: Boolean, unique: false, required: true, default: false },
            necessidadeDemolir: { type: Boolean, unique: false, required: true, default: false },
            necessidadeConstruir: { type: Boolean, unique: false, required: true, default: false },
            outros: { type: String, unique: false, required: true, default: '' },
