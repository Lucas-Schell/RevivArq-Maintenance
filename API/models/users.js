    ...
    const schema = new Schema(
        {
            ...
            password: {
                ...
                required: true,
                select: false
            }, // select: false indica que não irá vir nas queries de seleção deste tipo de DOC, para incluir usar +password, por exemplo: "Users.findOne({_id: id}).select('+password').exec(...)" ou qualquer variante deste comando
            salt: {
                type: String,
                unique: false,
                required: true,
