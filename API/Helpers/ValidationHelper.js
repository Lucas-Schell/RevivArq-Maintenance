...
class ValidationHelper {
  ...
  static validRestrictions(restrictions) {
    return (
      !!restrictions && restrictions.length >= 0 && restrictions.length <= 100
    );
  }
  ...
  static validUserRegister(
    ...
    else if (!ValidationHelper.validName(name)) message = constants.invalidName;
  ...
  static validReformRegister(
    ...
    else if (!ValidationHelper.validArea(area)) message = constants.invalidArea;
    else if (!ValidationHelper.validGoal(goal)) message = constants.invalidGoal;
