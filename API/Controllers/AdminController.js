...
class AdminController {
    ...
    static addAdminUser(newUserData, callback) {
        const { cpf, password, name, email, lastName, address, civilStatus, cnpj, isAdmin, id } = newUserData
        ...
        let salt = AdminController.randomSHA256(constants.minRandomNumber, constants.maxRandomNumber)
        ...
        return DAO.addUser(newUserData, callback)
            ...
            let errorObj = { statusDesc: constants.userIsNotAdmin, statusCode: constants.invalidUser }
            return callback(errorObj, null)
        }
    }
